...
MainSearchBookModel bookFromJson(String str) => MainSearchBookModel.fromJson(json.decode(str));

String bookToJson(MainSearchBookModel data) => json.encode(data.toJson());

class MainSearchBookModel {
  ...
  factory MainSearchBookModel.fromJson(Map<String, dynamic> json) => MainSearchBookModel(
